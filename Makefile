...
thesis.pdf: thesis.tex
	export TEXMFHOME=./texmf/; latexmk -quiet -bibtex $(PREVIEW_CONTINUOUSLY) -f -pdf -pdflatex="lualatex -synctex=1 -interaction=nonstopmode -shell-escape" -use-make thesis.tex
